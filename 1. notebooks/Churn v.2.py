...
acuracia = [0.89, 0.87, 0.91, 0.93]
recall = [0.85, 0.86, 0.90, 0.91]
f1_score = [0.87, 0.86, 0.91, 0.92]
...
# Criação do gráfico
plt.figure(figsize=(10, 6))
bars1 = plt.bar(x - bar_width, acuracia, width=bar_width, label='Acurácia', color='royalblue' )
bars2 = plt.bar(x, recall, width=bar_width, label='Recall', color='deepskyblue' )
bars3 = plt.bar(x + bar_width, f1_score, width=bar_width, label='F1-score', color='skyblue' )
...
#plt.savefig("images/comparacao_metricas_modelos_numeros.png")  # Caminho relativo sugerido
plt.show()
